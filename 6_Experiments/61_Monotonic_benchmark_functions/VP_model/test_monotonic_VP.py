...
if __name__ == "__main__":
    ...
    RMSE_mean, RMSE_std, lpd_mean, lpd_std, rhat_test, x_train, y_train, fpred, sigma, rs_array, params_array = run_simulation(best_configuration['num_virtual'], parameter_names, seed_0 = 1234*(args.b_function_index + 1))
