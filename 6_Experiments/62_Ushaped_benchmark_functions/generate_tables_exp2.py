...
model_names = ['baseline GP', 'HS model', 'HS relaxed model', 'VP model']

benchmark_functions = ['flat', 'skew', 'parabola', 'abs', 'sine', 'step']
...
models = ['HS_model', 'HS_2deriv_model', 'VP_model']
model_names = [model.replace('_', ' ') for model in models]
benchmark_functions = ['flat', 'parabola', 'skew', 'sine', 'abs', 'step']
