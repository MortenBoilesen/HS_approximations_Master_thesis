...
def run_simulation(num_virtual, parameter_names, index, seed_0 = 0):
    ...
    return RMSE, lpd, rhat_test, x_train, y_train, fpred, sigma, params_array, rs_array
...
if __name__ == "__main__":
    ...
    RMSE, lpd, rhat_test, x_train, y_train, fpred, sigma, params_array, rs_array = run_simulation(best_configuration['num_virtual'], parameter_names, args.index, seed_0 = 1234*(args.b_function_index + 1))
