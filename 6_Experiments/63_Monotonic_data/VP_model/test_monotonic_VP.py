...
if __name__ == "__main__":
    ...
    RMSE_array, lpd_array, rhat_test, f_pred, sigma, params, rs = run_simulation(best_configuration['num_virtual'], simulation_code, parameter_names, x_train, x_test, x_pred, y_train, y_test)
